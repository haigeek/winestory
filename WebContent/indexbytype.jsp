                                        ...
                                        <c:forEach items="${storyList }" var="story">
                                            <li class="mdui-list-item mdui-ripple">
                                                ...
                                                <div class="mdui-list-item-content">
                                                    ...
                                                    <div class="mdui-list-item-text "><a href="${pageContext.request.contextPath }/user_usershow.action?user.uid=${story.user.uid}">${story.user.username}</a>发表在${story.infoType.typeName} 在<fmt:formatDate
